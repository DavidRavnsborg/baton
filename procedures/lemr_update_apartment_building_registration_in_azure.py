...
def lemr_update_apartment_building_registration(config):
    ...
    storage_client.print_blobs(container_name=container_name)


if __name__ == "__main__":
    procedure_name = get_file_name(__file__)
    print(f"Running {procedure_name} procedure")
    lemr_update_apartment_building_registration(load_config())
